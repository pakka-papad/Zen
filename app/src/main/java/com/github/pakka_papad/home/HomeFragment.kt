...
/**
 * Support for swipe gestures added in constraint-layout version 1.1.0-alpha01
 *
 * https://github.com/androidx/constraintlayout/wiki/What%27s-New-in-1.1-%28Compose%29#known-issues-1
 */
@OptIn(ExperimentalMotionApi::class)
@Composable
fun HomeFragmentLayout(
    homeScreen: @Composable BoxScope.() -> Unit,
    nowPlayingScreen: @Composable BoxScope.() -> Unit,
